export default function Star({ text = 'Star' }) {
    return (
        <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M20 12L22 12" stroke="#d9ff00" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M6 18L6.34305 17.657" stroke="#d9ff00" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M17.6567 6.34326L18 6" stroke="#d9ff00" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M18 18L17.657 17.657" stroke="#d9ff00" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M6.34326 6.34326L6 6" stroke="#d9ff00" strokeWidth="1.5" strokeLinecap="round" />
            <path 
