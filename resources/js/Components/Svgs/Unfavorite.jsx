export default function UnFavorite({ text = 'Favorite' }) {
    return (
        <svg width="25px" height="25px" fill="rgb(79 70 229)" viewBox="-7.74 0 31.832 31.832" xmlns="http://www.w3.org/2000/svg">
            <title>{text}</title>
