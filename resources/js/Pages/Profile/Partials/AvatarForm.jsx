...
export default function AvatarForm({ className = '' }) {
    ...
    return (
        <section className={className}>
            <header>
                <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">{translate["Avatar"]}</h2>

                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    {translate["Upload/update your avatar"]}
                </p>
                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    {translate["To remove the avatar, just save without uploading an avatar"]}
                </p>
            </header>
